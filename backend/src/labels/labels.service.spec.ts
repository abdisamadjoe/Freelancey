...
import { DEFAULT_LABEL_COLOR } from "@/shared";

const mockPrisma = {
  label: {
    findMany: vi.fn(() => Promise.resolve([])),
    findFirst: vi.fn(() => Promise.resolve(null)),
    create: vi.fn(() => Promise.resolve({ id: "lbl-1", name: "Bug", color: "#ef4444", organizationId: "org-1" })),
    update: vi.fn(() => Promise.resolve({ id: "lbl-1", name: "Updated", color: "#ef4444" })),
    delete: vi.fn(() => Promise.resolve()),
  },
  project: {
    findFirst: vi.fn(() => Promise.resolve({ id: "proj-1" })),
  },
  task: {
    findFirst: vi.fn(() => Promise.resolve({ id: "task-1" })),
  },
  file: {
    findFirst: vi.fn(() => Promise.resolve({ id: "file-1" })),
  },
  member: {
    findFirst: vi.fn(() => Promise.resolve({ id: "member-1" })),
  },
  projectLabel: {
    create: vi.fn(() => Promise.resolve({ id: "pl-1" })),
    deleteMany: vi.fn(() => Promise.resolve({ count: 1 })),
  },
  taskLabel: {
    create: vi.fn(() => Promise.resolve({ id: "tl-1" })),
    deleteMany: vi.fn(() => Promise.resolve({ count: 1 })),
  },
  fileLabel: {
    create: vi.fn(() => Promise.resolve({ id: "fl-1" })),
    deleteMany: vi.fn(() => Promise.resolve({ count: 1 })),
  },
  memberLabel: {
    create: vi.fn(() => Promise.resolve({ id: "ml-1" })),
    deleteMany: vi.fn(() => Promise.resolve({ count: 1 })),
  },
};
